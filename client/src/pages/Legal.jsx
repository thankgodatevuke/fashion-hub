...
const Legal = () => {
  ...
  // --- Handle hash on initial load and when hash changes ---
  useEffect(() => {
    const hash = location.hash.replace("#", "");
    if (hash) {
      // Wait a tiny bit for the DOM to fully render
      setTimeout(() => {
        switch (hash) {
          case "privacy":
  ...
  return (
    <>
      <SEO
        title="Legal — Privacy, Returns & Terms"
        description="ÉLYSÉE's privacy policy, return policy, and terms & conditions. Transparency is the foundation of trust."
        url="https://tgdev.com/legal"
      />
            ...
            <div className="lg:col-span-3 space-y-16">
              ...
              <section ref={privacyRef} id="privacy" className="scroll-mt-32">
                ...
                <div className="space-y-4 text-luxury-charcoal/80 font-light leading-relaxed text-sm md:text-base">
                  ...
                  <p>
                    At ÉLYSÉE, your privacy is paramount. This policy outlines
                  ...
                  <p>
                    ...
                    enhance your shopping experience—name, email address,
                    shipping address, payment details, and browsing behavior
                    (via cookies).
                  </p>
                  <p>
                    <strong className="text-luxury-black font-medium">
                  ...
                  <p>
                    ...
                    or delete your data at any time. Simply contact our
                    concierge at{" "}
              ...
              {/* ---- RETURNS & REFUNDS ---- */}
              <section ref={returnsRef} id="returns" className="scroll-mt-32">
                <div className="flex items-center gap-4 mb-6">
                  <span className="w-8 h-0.5 bg-luxury-gold" />
                  <h2 className="text-2xl md:text-3xl font-serif font-light">
                ...
                <div className="space-y-4 text-luxury-charcoal/80 font-light leading-relaxed text-sm md:text-base">
                  <p>
                    ...
                    We want you to love your ÉLYSÉE piece. If you are not
                    entirely satisfied, we offer a hassle-free return policy.
                  </p>
                  <p>
                    <strong className="text-luxury-black font-medium">
                      Return window:
                    ...
                    You have{" "}
                    <strong className="text-luxury-black">14 days</strong> from
                  ...
                  <p>
                    ...
                    reserve the right to refuse returns that show signs of wear
                    or damage.
                  </p>
                  <p>
                    <strong className="text-luxury-black font-medium">
                    ...
                    to request a return authorization. We will provide you with
                    a prepaid shipping label (deducted from your refund) or
                  ...
                  <p>
                    ...
                    your refund within 5–7 business days. Refunds are issued to
                    the original payment method. Original shipping costs are
                  ...
                  <p>
                    ...
                    swimwear, or earrings. Bespoke or custom-made items are
                    final sale.
                  </p>
                </div>
              </section>
              ...
              <section ref={termsRef} id="terms" className="scroll-mt-32">
                ...
                <div className="space-y-4 text-luxury-charcoal/80 font-light leading-relaxed text-sm md:text-base">
                  ...
                  <p>
                    ...
                    designs—is the exclusive property of ÉLYSÉE. Unauthorized
                  ...
                  <p>
                    ...
                    without notice. While we strive for accuracy, we reserve the
                    right to correct errors in pricing or product descriptions.
                    In the event of a pricing error, we will contact you before
              ...
              {/* ---- F.A.Q SECTION ---- */}
              <section ref={faqRef} id="faq" className="scroll-mt-32">
                <div className="flex items-center gap-4 mb-6">
                  <span className="w-8 h-0.5 bg-luxury-gold" />
                  <h2 className="text-2xl md:text-3xl font-serif font-light">
                    F.<span className="font-bold">A.Q</span>
                  </h2>
                </div>
                <div className="space-y-6 text-luxury-charcoal/80 font-light leading-relaxed text-sm md:text-base">
                  <div>
                    <h4 className="font-serif text-lg font-medium text-luxury-black">
                      How long does shipping take?
                    </h4>
                    <p className="mt-1">
                      We offer express shipping worldwide. Orders are processed
                      within 24 hours and delivered within 3–5 business days.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-serif text-lg font-medium text-luxury-black">
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      Yes, we offer exchanges for items in their original
                      condition. Please contact our concierge team to arrange a
