...
import SEO from "../components/SEO"; // <-- Import at the top

const About = () => {
  return (
    <>
      {/* ✅ SEO COMPONENT - NOW IN THE CORRECT LOCATION */}
      <SEO
        title="About Us — The Art of Modern Luxury"
        description="Learn about ÉLYSÉE's philosophy, craftsmanship, and commitment to timeless luxury fashion."
        url="https://tgdev.com/about"
      />
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 border-b border-luxury-cream">
          ...
          <div className="space-y-6 text-luxury-gray font-light leading-relaxed">
            <p>
              ...
              between minimalist discipline and maximalist expression. We
              believe that true luxury is not loud—it is felt in the weight of a
              fabric, the precision of a seam, and the silent confidence of a
              perfect silhouette.
            </p>
            <p>
              Our collections are crafted from the world's finest materials,
              sourced ethically from Italy, Japan, and beyond. Each piece is
              designed to transcend seasons, becoming a staple in the wardrobes
              of those who appreciate enduring design over fleeting trends.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 border-b border-luxury-cream">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            ...
            <div>
              ...
              <p className="text-sm text-luxury-gray font-light leading-relaxed">
                We trace every thread to its origin. Our supply chain is
                ethical, sustainable, and fully traceable.
              </p>
            </div>
            <div>
              <div className="w-12 h-0.5 bg-luxury-gold mx-auto mb-6" />
              ...
              <p className="text-sm text-luxury-gray font-light leading-relaxed">
                We reject the fast-fashion cycle. Our pieces are designed to
                exist beyond the whims of the season.
              </p>
            </div>
          </div>
        </div>
