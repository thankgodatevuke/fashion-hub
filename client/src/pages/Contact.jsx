  ...
  return (
    <>
      ...
      <SEO
        ...
        description="Reach out to ÉLYSÉE's concierge team for styling advice, order inquiries, or any questions."
        url="https://tgdev.com/contact"
      />
      ...
      <div className="pt-24 md:pt-32 pb-20 bg-luxury-white">
        ...
        <div className="max-w-7xl mx-auto px-6 mb-16 text-center">
          ...
          <p className="text-luxury-charcoal font-light mt-4 max-w-xl mx-auto">
            For styling advice, order inquiries, or just to say hello — reach
