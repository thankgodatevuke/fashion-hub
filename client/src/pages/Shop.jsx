...
const Shop = () => {
  ...
  // Get search query from URL (e.g., ?search=two%20piece)
  ...
  return (
    <>
      ...
      <SEO
        ...
        description="Explore our curated collection of luxury fashion for men and women. Premium fabrics, timeless designs."
        url="https://tgdev.com/shop"
      />
      ...
      <div className="pt-28 px-6 max-w-7xl mx-auto pb-20">
        ...
        {sortedProducts.length === 0 ? (
          <div className="text-center py-20">
            ...
            <button
              onClick={() =>
                setSearchParams({ gender: "All", category: "All" })
              }
